(()=>{
  ...
  window.ORBITFriday={setSpeaking,setOrbState,setMusicLevel,speak,getGreeting,getBootNarration,pickGermanVoice,speakSeraphina,startBootMusic,stopBootMusic,voiceProfile:FRIDAY_VOICE_PROFILE,privateMusicUrl:PRIVATE_MUSIC_URL};
