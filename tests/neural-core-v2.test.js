...
for(const ref of ['styles.css?v=6','start-v2.css?v=21','neural-core-v2.js?v=7'])assert.ok(html.includes(`"${ref}"`), `canonical entry must use fresh cinematic asset ${ref}`);
